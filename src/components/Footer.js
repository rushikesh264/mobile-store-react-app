...
function Footer() {
  return (
    <div className="container-fluid pt-lg-5 mt-lg-5 p-sm-1 bg-dark text-white ">
      <div className="row">
        <div className="col-15 mx-auto  py-4 col-lg-2 text-left ">
            <div className="row mx-auto p-1 m-1 ">
                <Link to="/" style={{textDecoration:"none"}}>
                    <h2 className="font-weight-bold text-white" ><i className="fa fa-shopping-bag mr-2"/>Quick<span className="text-warning">shop</span></h2> 
                </Link>
            </div>
            <div className="row mx-auto p-1 m-1">
